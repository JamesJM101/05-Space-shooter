...
ENEMY_MIN_MASS = 10
ENEMY_MAX_MASS = 45
ENEMY_ACCELERATION = 11
ENEMY_MAX_ACCELERATION = 4
ENEMY_PROB_SHOOT = 0.04
...
class Enemy(arcade.Sprite):
    def __init__(self, x, y, mass, hp):
        sprites = ['enemy1','enemy2','enemy3','enemy4','enemy5']
...
class Window(arcade.Window):
    ...
    def __init__(self, width, height, title):
        ...
        self.level = 0
        self.levels = [
            ("Level 1","assets/Background.png",NUM_ENEMIES,1)
            ,("Level 2","assets/Background.png",NUM_ENEMIES+3,1.5)
        ]
